    ...
    return (
        <header className={clsx("header", cn)}>
            <div className="header__button-wrapper">
                <IconButton cn={clsx("header__button-back-icon", left && "header__button-back-icon_show")} src="/img/icon_back.svg" onClick={() => navigate(-1)} />
                ...
                <IconButton cn={clsx("header__button-exit-icon")} src="/img/icon_exit.svg" onClick={() => handleLogout()} />
            </div>
